...
private:
    ...
    void prepareImGui()
    {
        ...
        imGui->initResources(renderPass, vulkanDevice->graphicsQueue, false);
    }
    void mainLoop() {
    ...
    void drawScene(VkCommandBuffer cmd, Frame* frame) 
    {
        ...
        dstSet = 1;             //texture
        vkCmdBindDescriptorSets(cmd, VK_PIPELINE_BIND_POINT_GRAPHICS, piHub.piLayout_solidTex, dstSet, 1, &frame->set_pillar, 0, nullptr);
        batchIdx = 0;
        ...
        dstSet = 2;
        vkCmdBindDescriptorSets(cmd, VK_PIPELINE_BIND_POINT_GRAPHICS, piHub.piLayout_instance, dstSet, 1, &frame->set_pillar, 0, nullptr);
        batchIdx = 1;
