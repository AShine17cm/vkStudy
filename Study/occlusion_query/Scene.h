...
struct  Scene
{
	...
	{
        sceneObject.push_back(new geos::GeoCube(0.2f, { -0.5f,0.3f,0.1f })); sceneObject[0]->name = "Small Cube";
        sceneObject.push_back(new geos::GeoCube(0.3f, { 0.5f,0.8f,0.15f })); sceneObject[1]->name = "Big Cube";
