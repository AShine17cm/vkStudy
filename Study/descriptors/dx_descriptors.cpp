...
private:
    ...
    void createResources() 
    {
        ...
        uint32_t countSampler = MAX_FRAMES_IN_FLIGHT * (1 + 1);
        /* Pool */
    ...
    void drawScene(VkCommandBuffer cmd, Frame* frame) 
    {
        ...
        vkCmdBindDescriptorSets(cmd, VK_PIPELINE_BIND_POINT_GRAPHICS, piHub.piLayout_Occluder, dstSet, 1, &frame->setFloor_1, 0, nullptr);
        batchIdx = 1;
        scene.draw(cmd, piHub.piLayout_Occluder, batchIdx);
        batchIdx = 2;
        scene.draw(cmd, piHub.piLayout_Occluder, batchIdx);
    }
